...
entity `Map`s (104 remaining after the commerce, compliance, logistics, and
suppliers/sales-agents/receipts extractions below) behind one shared auth
gate, one generic in-memory snapshot/restore cycle, one generic
