...
| CP5        | Business Core Records                       |  active |  2026-07-02 |     pending | `checkpoint/cp5-business-core-records`   | Product, customer, supplier, inventory quantity, movement events, and local business validation are in progress.                       |
