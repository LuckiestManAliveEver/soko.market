...
| CP7        | Offline Local Data and Sync Queue           |  active |  2026-07-03 |     pending | `checkpoint/cp7-offline-sync`            | Officially started after CP6 passed; focuses on durable local reads, queued mutations, replay, and conflict handling.                  |
