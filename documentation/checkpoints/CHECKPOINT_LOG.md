...
| CP4        | Rule-Based AI Entry Point                   |  active |  2026-07-02 |     pending | `checkpoint/cp4-rule-parser`             | Officially opened after CP3 passed; adds deterministic parser behavior behind the chat shell without model dependency.                 |
