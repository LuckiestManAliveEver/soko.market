...
| CP6        | Invoice and Inventory Flow                  |  active |  2026-07-03 |     pending | `checkpoint/cp6-invoice-inventory`       | Opened after CP5 passed. Builds deterministic invoice, invoice item, inventory sale movement, preview, and printable output flow.      |
