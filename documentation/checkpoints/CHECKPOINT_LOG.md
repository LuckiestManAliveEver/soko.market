...
| CP11       | llama.cpp Local Model Adapter               |  active |  2026-07-04 |     pending | `checkpoint/cp11-local-model-adapter`    | CP11 opened to attach a local llama.cpp-compatible model adapter behind the CP10 runtime contract.                                                 |
