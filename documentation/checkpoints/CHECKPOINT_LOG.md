...
| CP10       | Sokoclaw Runtime Full Adapter               |  active |  2026-07-03 |     pending | `checkpoint/cp10-sokoclaw-runtime`       | Builds the runtime adapter around deterministic tools, confirmation gates, verification, telemetry, and evaluation.                               |
