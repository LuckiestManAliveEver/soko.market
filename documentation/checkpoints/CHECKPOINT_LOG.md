...
| CP12       | Reports, Notifications, and Knowledge Layer |  active |  2026-07-04 |     pending | `checkpoint/cp12-reports-knowledge`      | CP12 opened to add deterministic reports, in-app notification primitives, and bounded runtime knowledge summaries.                                 |
