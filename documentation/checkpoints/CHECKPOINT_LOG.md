...
| CP3        | Mobile Shell and Chat Shell                 |  active |  2026-07-02 |     pending | `checkpoint/cp3-mobile-chat-shell`       | Officially opened after CP2 passed; establishes installable mobile shell, chat shell, quick actions, and placeholder states.           |
