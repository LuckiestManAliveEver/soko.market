...
import {
  ...
  type NormalizedContactRecordInput,
  normalizeContactRecordInput,
  validateContactRecordInput
} from "./domains/contact-records";
...
export type { ContactRecordInput, NormalizedContactRecordInput };
export { normalizeContactRecordInput, validateContactRecordInput };
