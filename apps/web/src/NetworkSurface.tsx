...
export function NetworkSurface(props: NetworkSurfaceProps) {
  ...
  return (
    <>
        ...
        <div className="surface-header-row">
          <div>
            ...
            <p className="shell-note">
              Your contacts help Soko build your first commerce network. Social connections expand
              it; friends-of-friends are reached through friends' agents.
            </p>
          </div>
      ...
      <CanonicalContactsCard businessId={props.businessId} />
    </>
  );
}
