 ...
 */
export function publicAgentReplyText(parsed: ReturnType<typeof parseRuntimeModelOutput>): string | null {
...
export function normalizeAgentEvaluationPolicy(value: AgentEvaluationPolicy): AgentEvaluationPolicy {
  return {
...
export function normalizeRuntimeToolNames(value: RuntimeToolName[], label: string): RuntimeToolName[] {
...
export function normalizeRuntimeOptionalText(value: string, label: string, maximumLength: number): string {
...
export function cloneInstalledAgentModel(model: InstalledAgentModelSummary): InstalledAgentModelSummary {
  return { ...model };
}

export function cloneAgentModelBinding(binding: AgentModelBindingSummary): AgentModelBindingSummary {
  return {
    ...binding,
...
export function normalizeBrowserRuntimeContract(contract: BrowserRuntimeContract): BrowserRuntimeContract {
  if (
...
export function normalizeFallbackPolicy(policy: AgentModelFallbackPolicy): AgentModelFallbackPolicy {
  if (
    policy === "NEVER" ||
